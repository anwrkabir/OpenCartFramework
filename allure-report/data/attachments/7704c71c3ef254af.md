...
- Name:  Search product
- Location: C:\OpenCartPlaywright\tests\SearchProduct.spec.ts:35:5
...
Call log:
  - waiting for locator('input[placeholder=\'Search\']')
    ...
    at HomePage.enterProductName (C:\OpenCartPlaywright\pages\HomePage.ts:78:31)
    at C:\OpenCartPlaywright\tests\SearchProduct.spec.ts:37:14
```
