...
Expected: true
Received: {Symbol(async_id_symbol): 8492, Symbol(trigger_async_id_symbol): 1576, Symbol(kResourceStore): undefined}
    at C:\OpenCartPlaywright\tests\AccountReg_del.spec.ts:31:40
```
...
> 31 |     expect(homePage.isHomePageExist()).toBe(true);
     |                                        ^ Error: expect(received).toBe(expected) // Object.is equality
